...
if api.connect(ip='119.147.212.81', port=7709):
    ...
    for idx in code_list.index:
        ...
        df = api.to_df(api.get_security_bars(9, security_market, security_code, history_day_count, 10 + 2))
